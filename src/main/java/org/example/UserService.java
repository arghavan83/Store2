...
public class UserService extends ProductService {
    ...
    public void sellerSignUp(String newUserName, String newPassword, String newEmailAddress, String newPhoneNumber) {
        Scanner input = new Scanner(System.in);
    ...
    public void userMenu(User user){
        ...
        System.out.println("Type3-if you want to add comment for a product");
